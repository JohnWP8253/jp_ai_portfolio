        ...
        <div className="cs-section-inner" style={{ maxWidth: '960px' }}>
          ...
          <div className="cs-diagram-wrap">
            <svg viewBox="0 0 860 320" xmlns="http://www.w3.org/2000/svg" fontFamily="DM Sans, sans-serif">
              ...
              <text x="410" y="271" textAnchor="middle" fill="#506070" fontSize="9.5" fontFamily="DM Mono,monospace">CloudWatch: logs, KPI dashboards, and error alerts at every Lambda boundary</text>
            </svg>
          </div>
